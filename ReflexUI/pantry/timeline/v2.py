            ...
            rx.animation(
                rx.box(
                    wrapper(
                        ...
                        [
                            rx.text(
                                "Working at Slack was one of the most beautiful experiences of my career. There are a lot of interesting things to learn, and managers respect your time and personality.",
                                size="1",
                            ),
                        ],
                    ),
